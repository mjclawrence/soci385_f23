...
Our test statistic is more extreme than that so we can reject the null hypothesis that the 2018 population mean is 2.2.
...
See slides for an example of how confidence intervals would also lead us to the same conclusion.
