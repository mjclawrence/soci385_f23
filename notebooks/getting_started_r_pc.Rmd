...
`R` is available as a free download at [`this site`](https://cran.rstudio.com). If your system software is up to date you should download version 4.2.1 for Windows. After choosing the base version of `R` you want, click to install and follow the on-screen instructions. You may have to double click on the downloaded package to start the process; that package should be in the folder where you saved the file.
