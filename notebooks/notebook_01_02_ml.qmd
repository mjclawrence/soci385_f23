...
How does R know what is code and what is regular text? In an Quarto document, code goes in a fenced code block. To open the fence, type three backticks and an r in curly brackets on a single line; to close the fence, type three backticks on a single line like this:
...
Let's start by using R as a basic calculator. Since even the following calculation is considered code we need to place it within a code block. After the opening fence, you can add options with the `#|` tag. One helpful option would be a label of what the code in that chunk does. Those short descriptions are collected as bookmarks in the drop down menu on the bottom of this pane and can help you find pieces of your file.

Note that multiple chunks cannot have the same label If they do, the file will not knit.
...
**Announcement about Data Camp**
All students in this class have a free six-month subscription to [Data Camp](https://www.datacamp.com) through which you can access any of their courses and tutorials. To register as part of our class, use your Middlebury email to sign up [here](https://www.datacamp.com/groups/shared_links/573dc5a953886ea5839da20e425e1d8726be36373492b26abeddcc2049bb7080). Sign up information will also be shared on Canvas.
